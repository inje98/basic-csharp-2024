...
namespace ex18_winApp
{
    public partial class FrmMain : Form
    {
        ...
        public FrmMain()
        {
            ...
            GrbEditor.Text = "텍스트에디터"; // 코드 비하인드 셋팅
        }
        ...
        private void TrbDummy_Scroll_1(object sender, EventArgs e)
        {
            PrgDummy.Value = TrbDummy.Value;
        }
        ...
        private void BtnFileLoad_Click(object sender, EventArgs e)
        {
            ...
            {
                // UTF-8이 한글이 깨짐. EUK-KR(Window 949), UTF-8(BOM)은 한글이 문제 없음.
        ...
        private void BtnNothread_Click(object sender, EventArgs e)
        {
            ...
            for (var i = 0; i <= maxValue; i++)
            {
                ...
                Thread.Sleep(1000); // 1000ms = 1초, 500ms = 0.5초
            }

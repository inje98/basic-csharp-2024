...
namespace Timer.Clock
{
    public partial class Timer : UserControl
    {
        ...
        bool isStop1min = true, isStop3min = true, isStop5min = true, isStop10min = true, isStopMymin;
        ...
        {
            remainingSecondsMymin = MyTotalSeconds;

            if (remainingSecondsMymin <= 0)
            {
                timerMymin.Stop();
            ...
            int hours = remainingSecondsMymin / 3600;
            int minutes = (remainingSecondsMymin % 3600) / 60;
            int seconds = remainingSecondsMymin % 60;
        ...
        private void button1_Click(object sender, EventArgs e) // 사용자 입력 초기화버튼
        {
            ...
            LblMyTime.Text = "00:00:00"; // Label 텍스트 초기화
            button8.Text = "시작";
        }
        ...
        private void button11_Click(object sender, EventArgs e) // 내가 정한 타이머 확인버튼
        {
            ...
            // remainingSeconds10min = (int)(startTime10min.AddMinutes(10) - DateTime.Now).TotalSeconds;
            // 
            // LblMyTime 이 라벨에 시간 넣기
            int hours = (int)NmrHour.Value;
            int minutes = (int)NmrMin.Value;
            int seconds = (int)NmrSec.Value;

            // 총 시간을 초 단위로 계산합니다.
            MyTotalSeconds = hours * 3600 + minutes * 60 + seconds;
